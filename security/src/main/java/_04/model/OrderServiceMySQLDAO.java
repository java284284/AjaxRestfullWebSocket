...
public class OrderServiceMySQLDAO implements IOrderDAO {
	private DataSource ds = null;
	private int key = 0;
	public OrderServiceMySQLDAO() throws NamingException, SQLException {
	...
	public int insert(String orderId, double amount) {
        int updateCount = 0 ;
        String sql = "INSERT INTO ProductOrders values(null, ?, ?)";
		try (
