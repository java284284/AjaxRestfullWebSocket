		...
		btnConn.onclick = function() {
			...
			socket.onclose = function(event) {
				if (event.wasClean) {
					...
					status.innerHTML = "[close] 連線不正常結束<br><font size='-2'>(必須取消CustomServerAppConfigProvider.java所有註解，並重起Server)</font>";
				}
				btnClose.disabled = true;
				btnSend.disabled = true;
			...
			socket.onerror = function(error) {
				console.log("[error] 連線發生錯誤，原因：" + error.message);
			};
		}
...
<div align='center'>
    ...
    <hr>
Server端程式：_01.ProgrammaticEchoEnpoint.java (程式型端點)<br>
