...
keytool -genkeypair -alias tomcat -keyalg RSA -dname "CN=Kitty Company,OU=Application Development,O=Kitty Company,L=KittyCity,S=LD,C=UK" -keypass password -keystore server.jks -storepass password -ext SAN=dns:localhost,ip:192.168.19.30
