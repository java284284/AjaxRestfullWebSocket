...
keytool -genkeypair -alias serverkey -keyalg RSA -dname "CN=KittyCompany, OU=Application Development,O=Kitty Company,L=KittyCity,S=LD,C=UK" -keypass password -keystore server.jks -storepass password -ext SAN=dns:localhost,ip:192.168.1.102
